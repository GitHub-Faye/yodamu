...
class PoseValidator(DetectionValidator):
    ...
    def init_metrics(self, model):
        ...
        # Use predefined sigma for COCO (17 keypoints) or face (5 keypoints)
        if nkpt == 17:  # COCO keypoints
            self.sigma = OKS_SIGMA
        elif nkpt == 5:  # Face keypoints
            self.sigma = np.array([0.026, 0.025, 0.025, 0.035, 0.035])  # Face keypoint sigmas
        else:
            self.sigma = np.ones(nkpt) / nkpt  # Default uniform sigma
